...
RcppExport SEXP _ieeeConverter_ieee_float_to_hex(SEXP fSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< float >::type f(fSEXP);
    rcpp_result_gen = Rcpp::wrap(ieee_float_to_hex(f));
...
RcppExport void R_init_ieeeConverter(DllInfo *dll) {
